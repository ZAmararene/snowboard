...
class TrickFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $trick1 = $this->create($manager, $name1, $content1, 'groupe1', 'picture1', 'video1');
        ...
        $trick2 = $this->create($manager, $name2, $content2, 'groupe3', 'picture4', 'video2');
        ...
        $trick3 = $this->create($manager, $name3, $content3, 'groupe2', 'picture2', 'video3');
        ...
        $trick4 = $this->create($manager, $name4, $content4, 'groupe5', 'picture3', 'video4');
        ...
        $trick5 = $this->create($manager, $name5, $content5, 'groupe8', 'picture5', 'video5');
        ...
        $trick6 = $this->create($manager, $name6, $content6, 'groupe6', 'picture6', 'video6');
        ...
        $trick7 = $this->create($manager, $name7, $content7, 'groupe7', 'picture7', 'video7');
        ...
        $trick8 = $this->create($manager, $name8, $content8, 'groupe8', 'picture8', 'video8');
        ...
        $trick9 = $this->create($manager, $name9, $content9, 'groupe3', 'picture9', 'video9');
        ...
        $trick10 = $this->create($manager, $name10, $content10, 'groupe5', 'picture10', 'video10');
        ...
        $trick11 = $this->create($manager, $name11, $content11, 'groupe1', 'picture11', 'video11');
        ...
        $trick12 = $this->create($manager, $name12, $content12, 'groupe3', 'picture12', 'video12');
        ...
        $trick13 = $this->create($manager, $name13, $content13, 'groupe8', 'picture13', 'video13');
        ...
        $trick14 = $this->create($manager, $name14, $content14, 'groupe3', 'picture14', 'video14');
        ...
        $trick15 = $this->create($manager, $name15, $content15, 'groupe5', 'picture15', 'video15');
        ...
        $trick16 = $this->create($manager, $name16, $content16, 'groupe4', 'picture16', 'video16');
        $this->addReference('trick16', $trick16);

        $manager->flush();
    }

    public function create($manager, $name, $content, $groupe, $picture, $video)
    {
        $trick = new Trick();
        $trick->setName($name);
